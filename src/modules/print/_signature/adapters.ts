...
export function invoiceToDocumentData({
  ...
  return {
    ...
    tax_total:      tax,
    round_off:      Number((invoice as { round_off_amount?: number }).round_off_amount ?? 0),
    shipping_total: 0,
    grand_total:    total,
    paid_amount:    paid,
...
export function vendorBillToDocumentData({
  ...
  return {
    ...
    tax_total:      tax,
    round_off:      Number((bill as { round_off_amount?: number }).round_off_amount ?? 0),
    shipping_total: 0,
    grand_total:    total,
...
export function quoteToDocumentData({
  ...
  return {
    ...
    tax_total:      tax,
    round_off:      Number((quote as { round_off_amount?: number }).round_off_amount ?? 0),
    shipping_total: 0,
    grand_total:    total,
    paid_amount:    0,
    balance_due:    total,
...
export function creditNoteToDocumentData({
  ...
  return {
    ...
    tax_total:      tax,
    round_off:      Number((creditNote as { round_off_amount?: number }).round_off_amount ?? 0),
    shipping_total: 0,
    grand_total:    total,
    paid_amount:    0,
    balance_due:    total,
...
export function debitNoteToDocumentData({
  ...
  return {
    ...
    tax_total:      tax,
    round_off:      Number((debitNote as { round_off_amount?: number }).round_off_amount ?? 0),
    shipping_total: 0,
    grand_total:    total,
    paid_amount:    0,
    balance_due:    total,
