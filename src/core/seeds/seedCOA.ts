...
const ALL_ACCOUNTS: (AccountDef & { gcc_only?: true; india_only?: true })[] = [
  ...
  // ── Income ────────────────────────────────────────────────────────────────
  { code: '4100', name: 'Sales Revenue',               name_ar: 'إيرادات المبيعات',        type: 'income' },
  { code: '4150', name: 'Sales Discounts',             name_ar: 'خصومات المبيعات',         type: 'income' },
  { code: '4200', name: 'Other Income',                name_ar: 'إيرادات أخرى',            type: 'income' },
  { code: '4300', name: 'Inventory Gain',              name_ar: 'أرباح المخزون',           type: 'income' },
  { code: '4400', name: 'Foreign Exchange Gain',       name_ar: 'أرباح فروق العملة',       type: 'income' },
  // ── COGS ──────────────────────────────────────────────────────────────────
  { code: '5100', name: 'Cost of Goods Sold',          name_ar: 'تكلفة البضاعة المباعة',   type: 'expense', sub_type: 'cogs' },
  { code: '5200', name: 'Purchase Discounts Received', name_ar: 'خصومات المشتريات المكتسبة', type: 'expense', sub_type: 'cogs' },
  // ── Expenses ──────────────────────────────────────────────────────────────
  // 6100 Salaries intentionally excluded — payroll deferred to v2 (Doc 5)
  { code: '6200', name: 'Rent & Utilities',            name_ar: 'إيجار ومرافق',            type: 'expense' },
  { code: '6300', name: 'Marketing & Advertising',     name_ar: 'تسويق وإعلان',            type: 'expense' },
  { code: '6400', name: 'Logistics & Shipping',        name_ar: 'لوجستيات وشحن',           type: 'expense' },
  { code: '6500', name: 'General & Administrative',    name_ar: 'مصروفات عمومية وإدارية', type: 'expense' },
  { code: '6600', name: 'Bank Charges',                name_ar: 'رسوم بنكية',              type: 'expense' },
  { code: '6700', name: 'Inventory Loss',              name_ar: 'خسائر المخزون',           type: 'expense' },
  { code: '6800', name: 'Bad Debts Expense',           name_ar: 'مصروف الديون المعدومة',   type: 'expense' },
  { code: '6900', name: 'Foreign Exchange Loss',       name_ar: 'خسائر فروق العملة',       type: 'expense' },
];
